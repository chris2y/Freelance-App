...
public class ProfileRecyclerViewAdapter extends RecyclerView.Adapter<ProfileRecyclerViewAdapter.ViewHolder> {
    ...
    public ProfileRecyclerViewAdapter(ArrayList<String> data, Context context) {
        this.dataSet = data;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.custom_profile_row_layout, parent, false);
