...
public class ChatRecyclerAdapter extends FirestoreRecyclerAdapter<ChatMessageModel, ChatRecyclerAdapter.ChatModelViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull ChatModelViewHolder holder, int position, @NonNull ChatMessageModel model) {
       ...
       if(model.getSenderId().equals(FirebaseUtil.currentUserId())){
          ...
          holder.rightChatTimeTextview.setText(FirebaseUtil.timestampToStringMessage(model.getTimestamp()));
       }else{
           holder.rightChatLayout.setVisibility(View.GONE);
           holder.leftChatLayout.setVisibility(View.VISIBLE);
           holder.leftChatTextview.setText(model.getMessage());
           holder.leftChatTimeTextview.setText(FirebaseUtil.timestampToStringMessage(model.getTimestamp()));
       }
    }
    ...
    class ChatModelViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView leftChatTextview,rightChatTextview,rightChatTimeTextview,leftChatTimeTextview;
        ...
        public ChatModelViewHolder(@NonNull View itemView) {
            ...
            rightChatTimeTextview = itemView.findViewById(R.id.right_chat_time_text_view);
            leftChatTimeTextview = itemView.findViewById(R.id.left_chat_time_text_view);
        }
    }
}
